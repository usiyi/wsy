				...
				<div class="hd">
					<ul>
						...
						<li class=""
							...
							<a href="PetServlet?action=selectFlower2">购买宠物</a>
						</li>
					</ul>
				</div>
				<div class="bd">
									...
									<tfoot>
										<tr class="text-c">
											<td colspan="6">总页数： ${totalPage} 页
												&nbsp;&nbsp;&nbsp;&nbsp; 当前第 ${currPage} 页
												&nbsp;&nbsp;&nbsp;&nbsp; <a
												href="PetServlet?action=schFlowerSalesRecord&currPage=${currPage-1 }">上一页</a>
												&nbsp;&nbsp;&nbsp;&nbsp; <a
												href="PetServlet?action=schFlowerSalesRecord&currPage=${currPage-1 }">下一页</a>
											</td>
										</tr>
									</tfoot>
