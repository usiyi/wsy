...
<body>
	<div class="dvheader">
		<div class="dvheadertools">
			<span class="headerspantitle">管理员,您好！您是本站的第<%=application.getAttribute("count") %>位访客哟~</span>
			<ul class="headerultools">
				<li class="headerlitools_info headerlitools"
					...
					</div> 店员<i style="margin-left: 8px;" class="icon-caret-down"></i>
		...
		<ul class="ulleftmenu" style="border-right: 1px solid #ddd;">
			<li class="limenuitem"><i class="icon-cog menuicon"></i>操作菜单<b
				...
				<ul class="ulleftsubitems">
					<a href="TypeServlet?action=schType&type=${type.type_id}"
						target="right">
						<li>分类管理</li>
					</a>
					<a href="PetServlet?action=schPet&itemId=${item.id}"
						target="right">
						<li>宠物管理</li>
					</a>
					<a href="PetServlet?action=schPetPurchaseRecord" target="right">
						<li>进货管理</li>
					</a>
					<a href="PetServlet?action=schPetSalesRecord" target="right">
						<li>订单管理</li>
					</a>
